...
class ObjectDetection:
    def __init__(self):
        ...
        self.MODEL = cv2.dnn.readNet(
            os.path.join(MODELS_PATH, "C:/Users/meghr/Downloads/sused 1/models/yolov3.weights"),
            os.path.join(MODELS_PATH, "C:/Users/meghr/Downloads/sused 1/models/yolov3.cfg")
        )

        self.CLASSES = []
        with open(os.path.join(MODELS_PATH, "C:/Users/meghr/Downloads/sused 1/models/coco.names"), "r") as f:
